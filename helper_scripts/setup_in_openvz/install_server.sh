#!/bin/bash
# Script to configuring an rmnetdov3 server in a Debian VPS
...
tar xfz /root/downloads/rmnetdov-3.0.0.7-beta.tar.gz -C /usr/local/src
# here would be some stuff to update from SVN
cd /usr/local/src/rmnetdov3_install/install/
php -q install.php
