...
class backup
{
    ...
    /**
     * Returns default backup format used in previous versions of RM-Net - DOV
    ...
    {
        //We have a backup from old version of RM-Net - DOV
        switch ($backup_type) {
            case 'mysql':
                return 'gzip';
            case 'web':
            ...
            case 'tar_gzip':
                if ($app->system->is_installed('pigz')) {
                    ...
                    if ($backup_mode == 'user_zip') {
                        ...
                        //Standard casual behaviour of RM-Net - DOV
    ...
    protected static function make_database_backup($web_domain, $backup_job)
    {
        ...
        include '/usr/local/rmnetdov/server/lib/mysql_clientdb.conf';
                ...
                if (!empty($backup_extension_db)) {
                    ...
                    if ($exit_code == 0) {
                        if (is_file($db_backup_dir . '/' . $db_compressed_file)) {
                            ...
                            $sql = "INSERT INTO web_backup (server_id, parent_domain_id, backup_type, backup_mode, backup_format, tstamp, filename, filesize, backup_password) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
                            //Making compatible with previous versions of RM-Net - DOV:
    ...
    protected static function make_web_backup($web_domain, $backup_job)
    {
        ...
        //Check if we're working with data saved in old version of RM-Net - DOV
