...
class nginx_reverseproxy_plugin {
	...
	*/
	...
	function update($event_name, $data) {
		...
		if(!is_dir('/var/log/rmnetdov/nginx/'.$data['new']['domain'])) $app->system->exec_safe('mkdir -p ?', '/var/log/rmnetdov/nginx/'.$data['new']['domain']);
		...
		if($this->action == 'update' && $data['old']['domain'] != '' && $data['new']['domain'] != $data['old']['domain']) {
			...
			if(is_dir('/var/log/rmnetdov/nginx/'.$data['old']['domain'])) $app->system->exec_safe('rm -rf ?', '/var/log/rmnetdov/nginx/'.$data['old']['domain']);
		}
	...
	function delete($event_name, $data) {
		...
		if($data['old']['type'] == 'vhost' || $data['old']['type'] == 'vhostsubdomain' || $data['old']['type'] == 'vhostalias') {
			...
			$vhost_logfile_dir = '/var/log/rmnetdov/nginx/'.$data['old']['domain'];
