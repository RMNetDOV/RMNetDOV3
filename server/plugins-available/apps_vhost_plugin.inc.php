	...
	*/
	...
	function update($event_name, $data) {
		...
		if($web_config['server_type'] == 'apache'){
			...
			if(is_file('/usr/local/rmnetdov/interface/ssl/rmnetdovserver.crt') && is_file('/usr/local/rmnetdov/interface/ssl/rmnetdovserver.key')) {
				$tpl->setVar('ssl_comment','');
			} else {
				$tpl->setVar('ssl_comment','#');
			}
			if(is_file('/usr/local/rmnetdov/interface/ssl/rmnetdovserver.crt') && is_file('/usr/local/rmnetdov/interface/ssl/rmnetdovserver.key') && is_file('/usr/local/rmnetdov/interface/ssl/rmnetdovserver.bundle')) {
