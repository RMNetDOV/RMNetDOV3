...
$app->tpl->setInclude('content_tpl', 'templates/import_rmnetdov.htm');
$msg = '';
$error = '';

//* load language file
$lng_file = 'lib/lang/'.$app->functions->check_language($_SESSION['s']['language']).'_import_rmnetdov.lng';
include $lng_file;
$app->tpl->setVar($wb);
...
//* SET csrf token
$csrf_token = $app->auth->csrf_token_get('rmnetdov_import');
