...
$dropDown = "<select id='server_id' onchange=\"RMNetDOV.loadContent('monitor/show_sys_state.php?state=server&server=' + document.getElementById('server_id').value);\" class='form-control'>";
...
$items[] = array( 'title'  => "RM-Net - DOV CP Cron-Log",
	'target'  => 'content',
	'link' => 'monitor/show_log.php?log=log_rmnetdov_cron',
	'html_id' => 'log_rmnetdov_cron');
