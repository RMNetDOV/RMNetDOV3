...
// grep soap-\> /usr/share/roundcube/plugins/rmnetdov3_*/rmnetdov3_*.php | sed -e 's/^.*soap->//g' -e 's/(.*$//g' | sort -u | xargs | sed -e 's/ /,/g'
//
...
// functions used by rmnetdov_acmeproxy:  https://git.ispconfig.org/ispconfig/Modules/-/tree/master/ispc_acmeproxy
//
$function_list['client_get_by_username,client_get_id,dns_zone_get,dns_zone_get_by_user,dns_zone_update,dns_txt_add,dns_txt_get,dns_txt_delete'] = 'RM-Net - DOV CP module: acme proxy functions';
