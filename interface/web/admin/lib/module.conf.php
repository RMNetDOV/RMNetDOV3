...
// RM-Net - DOV CP interface update has been removed. Please use rmnetdov_update.sh on the shell instead.
$items[] = array(   'title'  => 'Do RM-Net - DOV CP-Update',
	'target'  => 'content',
	'link' => 'admin/remote_action_rmnetdovupdate.php',
	'html_id'   => 'rmnetdovupdate');
...
if(is_array($modules)) {
	foreach($modules as $mt) {
		if(is_file($mt.'/lib/admin.conf.php')) {
			$options = array();
			include_once RMNETDOV_WEB_PATH."/$mt/lib/admin.conf.php";
			if(is_array($options)) {
