    ...
    */
	...
	public function login($username, $password, $client_login = false)
	{
		...
		if($app->is_under_maintenance()){
			throw new SoapFault('maintenance_mode', 'This RM-Net - DOV CP installation is currently under maintenance. We should be back shortly. Thank you for your patience.');
			return false;
		}
	...
	protected function klientadd($formdef_file, $reseller_id, $params)
	{
		...
		*/
		...
		if($app->remoting_lib->formDef["db_history"] == 'yes') {
			...
			$app->remoting_lib->rmnetdov_sysuser_add($params, $insert_id);
