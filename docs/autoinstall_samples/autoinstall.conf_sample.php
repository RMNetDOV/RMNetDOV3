<?php
$autoinstall['language'] = 'sl'; // de, en, sl (default)
...
$autoinstall['mysql_database'] = 'dbrmnetdov'; // default: dbispcongig
$autoinstall['mysql_charset'] = 'utf8'; // default: utf8
$autoinstall['http_server'] = 'nginx'; // apache (default), nginx
$autoinstall['rmnetdov_port'] = '8090'; // default: 8090
$autoinstall['rmnetdov_use_ssl'] = 'y'; // y (default), n
$autoinstall['rmnetdov_admin_password'] = 'admin'; // default: admin
$autoinstall['create_ssl_server_certs'] = 'y';
$autoinstall['ignore_hostname_dns'] = 'n';
$autoinstall['rmnetdov_postfix_ssl_symlink'] = 'y';
$autoinstall['rmnetdov_pureftpd_ssl_symlink'] = 'y';
...
$autoinstall['mysql_rmnetdov_user'] = 'rmnetdov'; // default: rmnetdov
$autoinstall['mysql_rmnetdov_password'] = bin2hex(random_bytes(20));
...
$autoinstall['mysql_master_database'] = 'dbrmnetdov'; // default: dbrmnetdov
...
$autoinstall['install_rmnetdov_web_interface'] = 'y'; // y (default), n
...
$autoupdate['mysql_master_database'] = 'dbrmnetdov'; // default: dbrmnetdov
...
$autoupdate['rmnetdov_port'] = '8090'; // default: 8090
$autoupdate['create_new_rmnetdov_ssl_cert'] = 'no'; // no (default), yes
$autoupdate['reconfigure_crontab'] = 'yes'; // yes (default), no
$autoupdate['create_ssl_server_certs'] = 'y';
$autoupdate['ignore_hostname_dns'] = 'n';
$autoupdate['rmnetdov_postfix_ssl_symlink'] = 'y';
$autoupdate['rmnetdov_pureftpd_ssl_symlink'] = 'y';
