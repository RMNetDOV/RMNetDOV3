...
class installer extends installer_base {
	...
	public function configure_dovecot()
	{
		...
		if(version_compare($dovecot_version,2) >= 0) {
			if(is_file($conf['rmnetdov_install_dir'].'/server/conf-custom/install/debian6_dovecot2.conf.master')) {
				copy($conf['rmnetdov_install_dir'].'/server/conf-custom/install/debian6_dovecot2.conf.master', $config_dir.'/'.$configfile);
			} else {
			...
			if(is_file($conf['rmnetdov_install_dir'].'/server/conf-custom/install/debian6_dovecot.conf.master')) {
				copy($conf['rmnetdov_install_dir'].'/server/conf-custom/install/debian6_dovecot.conf.master', $config_dir.'/'.$configfile);
			} else {
		...
		$content = rfsel($conf['rmnetdov_install_dir'].'/server/conf-custom/install/debian6_dovecot-sql.conf.master', 'tpl/debian6_dovecot-sql.conf.master');
