...
if (!defined('vlibTemplateClassLoaded')) {
	...
	include_once RMNETDOV_INSTALL_ROOT.'/install/lib/classes/tpl_error.inc.php';
	include_once RMNETDOV_INSTALL_ROOT.'/install/lib/classes/tpl_ini.inc.php';
	...
	class tpl{
		...
		private function _fileSearch($file)
		{
			...
			if(isset($_SESSION['s']['module']['name']) && isset($_SESSION['s']['theme'])) {
				if(is_file(RMNETDOV_THEMES_PATH.'/'.$_SESSION['s']['theme'].'/templates/'.$_SESSION['s']['module']['name'].'/'.$filename)) {
					return RMNETDOV_THEMES_PATH.'/'.$_SESSION['s']['theme'].'/templates/'.$_SESSION['s']['module']['name'].'/'.$filename;
				}
			}
	...
	//include_once (RMNETDOV_CLASS_PATH.'/vlibTemplate/debug.php');
	include_once RMNETDOV_INSTALL_ROOT.'/install/lib/classes/tpl_cache.inc.php';
